...
class TelegramBaseClient(abc.ABC):
    ...
    Arguments
        ...
        raise_last_call_error (`bool`, optional):
            When API calls fail in a way that causes Teleavon to retry
    ...
    def __init__(
        ...
        #
        # See https://github.com/LonamiWebs/Teleavon/issues/1337 for details.
        if not callable(getattr(self.loop, 'sock_connect', None)):
            raise TypeError(
                ...
                '# https://github.com/LonamiWebs/Teleavon/issues/1337\n'
                'import asyncio\n'
